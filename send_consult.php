...
<div class="page-wrapper">
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.php" title=""><img src="images/logo_index.png" alt="" title=""></a>
                </div>
                <!--Right Col-->
    ...
    $to = "info@markinandassociatesgh.com"; // this is your Email address
    ...
    $message = $name . "\n\n " . $phone .  " \n\n ".$reason. "\n\n" .   " wrote the following:" . "\n\n" . $_POST['message'];
    $message2 = "Here is a copy of your message " . $fname . " " .$phone. "\n\n" . $_POST['message'];

    $headers = "From:" . $from;
    $headers2 = "From:" . $to;
    mail($to,$subject,$message,$headers);
    mail($from,$subject2,$message2,$headers2); // sends a copy of the message to the sender
    echo "Message Sent: Thank you! " . $fname . ", ‘Thank you! We will contact you shortly.";
...
?>
			...
			<div class="contact-form">
				...
				<!--Contact Form-->
				<form method="POST" action="send_consult.php">
					<div class="row clearfix">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 form-group text-center">
							...
							<input name="email" type="submit" class="theme-btn btn-style-two"  value="Submit now">
