						...
						<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix">
                               ...
                               <li class="dropdown"><a href="#">Our EXPERTISE</a>
                                    <ul>
                                        <li><a href="realestatelaw.php">REAL ESTATE / PROPERTY LAW</a></li>
                                        <li><a href="litigation.php"> LITIGATION</a></li>
                                        <li><a href="immegrationlaw.php">IMMIGRATION LAW</a></li>
                                        <li><a href="Corporatelaw.php">CORPORATE LAW</a></li>
                                         <li><a href="commercial.php">COMMERCIAL LAW</a></li>
                                        <li><a href="gas.php">OIL & GAS LAW</a></li>
                                        <li><a href="energy.php">ENERGY LAW</a></li>
                                        <li><a href="ppp.php">PUBLIC PARTNERSHIP AGREEMENT</a></li>
                                        <li><a href="divorce.php">DIVORCE LAW</a></li>
                                    </ul>
                                </li>
		...
		<div class="auto-container">
			<div class="inner-container">
				...
				<div class="lower-content">
					<h2>Oil & Gas Law</h2>
					<p>We offer legal counsel in the area of contracts pertaining to the transporting and selling of produced oil and gas, our team is well-equipped to provide sound legal counsel. On a variety of contracts, Joint Venture agreements, challenges with regulatory compliance, and energy projects, we provide legal answers. We provide assistance with Contract preparation as well as Litigation support, Arbitration, and due diligence for the purchase of oil and gas enterprises.
